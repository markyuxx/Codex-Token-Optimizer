...
const tools = [
  ...
  { name: "run_command", description: "Execute a command through the optimizer command proxy with safeMode enabled by default.", inputSchema: { type: "object", properties: { command: { type: "string" }, cmd: { type: "string" }, args: { type: "array", items: { type: "string" } }, cwd: { type: "string" }, model: { type: "string" }, provider: { type: "string" }, safeMode: { type: "boolean" }, unsafe: { type: "boolean" }, allowlist: { type: "array", items: { type: "string" } }, allowCommand: { type: "array", items: { type: "string" } }, safeEnv: { type: "object", additionalProperties: { type: "string" } }, allowedEnv: { type: "object", additionalProperties: { type: "string" } }, timeoutMs: { type: "number" }, maxStdoutBytes: { type: "number" }, maxStderrBytes: { type: "number" }, maxBytes: { type: "number" }, maxLines: { type: "number" }, maxArtifactBytes: { type: "number" }, maxCommandLength: { type: "number" }, maxArgs: { type: "number" }, maxArgLength: { type: "number" } } } },
