  ...
  return {
    ...
    async countMessages({ model, messages }) {
      ...
      return {
        ...
        note: "OpenAI message counting uses local content tokens plus documented chat structure overhead; provider-side counts may differ by model revision.",
      };
    },
  };
}
